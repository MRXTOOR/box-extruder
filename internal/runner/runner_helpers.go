...
// urlMatchesAttackPattern checks the raw and (double-)decoded URL against the
// known XSS/SQLi pattern lists.
...
// decodeURLVariants returns the lowercased raw URL plus up to two query-unescape
// passes, handling double-encoded payloads like %2527 → %27 → '.
...
// queryHasInjectionChars flags ?q=/?x= values containing a quote, semicolon or
// double-dash — almost certainly a payload regardless of specific pattern.
